...
public class DeleteFieldFunctionTests
{
    ...
    {
        // Arrange
        var request = new FieldBank.Functions.Handlers.DeleteFieldRequest { Id = 1 }; // Updated to use the correct namespace
    ...
    {
        // Arrange
        var request = new FieldBank.Functions.Handlers.DeleteFieldRequest { Id = 0 }; // Updated to use the correct namespace
