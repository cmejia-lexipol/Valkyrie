...
public static class TestConfigurationHelper
{
    ...
    public static IServiceProvider CreateTestServiceProvider()
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            {
                ["ConnectionStrings:DefaultConnection"] = "Host=localhost;Database=Valkyrie;Username=postgres;Password=password"
            })
            .Build();

        // Register services
        services.AddValkyrieDbContext(configuration);
